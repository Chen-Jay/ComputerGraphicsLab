...
void main()
{
	...
	RedPointLight.Color=vec3(1.0,1.0,1.0);
	RedPointLight.AmbientIntensity=0.3;
	RedPointLight.DiffuseIntensity=0.2;
	...
	GreenPointLight.Color=vec3(1.0,1.0,1.0);
	GreenPointLight.AmbientIntensity=0.3;
	GreenPointLight.DiffuseIntensity= 0.2;
	...
	BluePointLight.DiffuseIntensity=0.2;
